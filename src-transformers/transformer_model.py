...
class ConvTransformer(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv3 = nn.Conv1d(in_channels=128, out_channels=256, kernel_size=8, stride=1)  # Feature Maps: (11, 256)
        ...
        self.pe = PositionalEncoding(d_model=256, dropout=0.1, max_len=33)
        sub_attention_fc = nn.TransformerEncoderLayer(d_model=256, nhead=4, dim_feedforward=256, batch_first=True, dropout=0.1)
