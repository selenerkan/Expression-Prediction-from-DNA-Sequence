...
class TransformerNet(nn.Module):
    ...
    def __init__(self,transformer_size=10):
        super().__init__()
        ...
        self.positional_encoding = PositionalEncoding(d_model=transformer_size, max_len=112)
        ...
        sub_attention_fc = nn.TransformerEncoderLayer(d_model=transformer_size, nhead=2, dim_feedforward=transformer_size * 2, batch_first=True)
        ...
        self.fc1 = nn.Linear(transformer_size, transformer_size//2)
...
class ConvTransformer(nn.Module):
    ...
    def __init__(self,transformer_size=512):
        super().__init__()
        # first layer num_filters = 64
        # larger kernel size
        # no lstm at the top of transformer
        ...
        # add positional encodings
        self.positional_encoding = PositionalEncoding(d_model=transformer_size, max_len=5)
